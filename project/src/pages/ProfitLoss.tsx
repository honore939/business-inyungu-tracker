...
const ProfitLoss = () => {
  ...
  const monthlyData = {
    ...
    revenue: [15000, 18000, 16000, 22000, 20000, 25000],
    expenses: [8000, 9000, 8500, 11000, 10000, 12000],
    profit: [7000, 9000, 7500, 11000, 10000, 13000]
  };
  ...
  return (
    <div className="space-y-6 animate-fade-in">
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between">
        <h1 className="text-2xl font-semibold text-gray-900 dark:text-white">Profit & Loss</h1>
