...
const Expenses = () => {
  ...
  const categories = ['Ubukode', 'Ibikorwa by\'ingenzi', 'Ibijyanye n\'isoko', 'Ibyihutirwa', 'Ingendo/Ubwikorezi', 'Ubwishingizi', 'Ibindi'];
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    if (editingExpense) {
      ...
      toast.success('Amafaranga asohoka yahinduwe neza!');
      ...
      toast.success('amafaranga asohoka yongeweho neza!');
    }
  ...
  const handleDelete = (id: string) => {
    if (confirm('Ese koko urashaka gusiba amafaranga yasohotse?')) {
      setExpenses(expenses.filter(exp => exp.id !== id));
      toast.success('Umaze gusiba amafaranga yasohotse!');
    }
  };
  ...
  return (
    <div className="space-y-6 animate-fade-in">
      ...
      <Card className="bg-red-50 dark:bg-red-900/20">
        <CardContent className="p-6">
          <div className="text-center">
            <p className="text-sm font-medium text-gray-500 dark:text-gray-400">Igiteranyo cyose cy'amafaranga yasohotse</p>
            <p className="text-3xl font-semibold text-red-600 dark:text-red-400">
              RWF{totalExpenses.toLocaleString()}
            </p>
            <p className="text-sm text-gray-500 dark:text-gray-400">
              {filteredExpenses.length} Amafaranga yasohotse{filteredExpenses.length !== 1 ? 's' : ''}
            </p>
          </div>
        </CardContent>
      </Card>
      ...
      <div className="relative">
        ...
        <input
          type="text"
          placeholder="Shakisha amafaranga yasohotse..."
      ...
      <Card>
        <CardHeader>
          <CardTitle>Amakuru ku mafaranga yasohotse</CardTitle>
        </CardHeader>
        <CardContent>
